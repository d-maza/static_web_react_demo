    ...
    <Box
      ...
      <Box
        ...
        boxSizing="content-box"
          ...
          <Text
            margin={{mb:'20px'}}
          >© 2023 DiveCode™. www.codigoutil.com</Text>
          <Stack direction={'row'} spacing={1}>
            <SocialButton label={'Envelope'} href={'mailto:davidmazaborjabad@gmail.com?Subject=Más%20información%20sobre%20sus%20productos'}>
              <FaRegEnvelope />
            </SocialButton>
